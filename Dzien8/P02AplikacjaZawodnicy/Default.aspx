                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <%for (int i = 0; i < Zawodnicy.Length; i++)
                                                {%>
                                            <tr>
                                                <td><a href="Szczegoly.aspx?id=<%= Zawodnicy[i].Id_zawodnika %>"><%= Zawodnicy[i].Imie + " " + Zawodnicy[i].Nazwisko %></a></td>
                                                <td><%= Zawodnicy[i].Kraj%></td>
                                                <td><%= Zawodnicy[i].Miasto%></td>
                                                <td class="text-center"><%= Zawodnicy[i].DataUr?.ToString("dd-MM-yyyy")%></td>
                                            </tr>
                                            <%
                                                };
                                            %>
                                    ...
                                    <div class="card-header">
                                        <h4 class="card-title">Trenerzy</h4>
                                    </div>
                                    <table class="table">
                                        <thead class=" text-primary">
                                            <th>Imie i Nazwisko</th>
                                        ...
                                        <tbody>
                                            <td>
                                                ...
                                                %>
                                                <p><a href="Szczegoly.aspx?id=<%= Trenerzy[i].Id_trenara %>"><%= Trenerzy[i].Imie_trenera +" "+ Trenerzy[i].Nazwisko_trenera %></a></p>
                                                <%
                                                    }
                                            ...
                                            <td>
                                                ...
                                                %>
                                                <p><%=Trenerzy[i].Data_ur_trenera?.ToString("dd-MM-yyyy") %></p>
                                                <%
                                                    }
