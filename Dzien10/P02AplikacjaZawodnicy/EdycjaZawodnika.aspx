<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EdycjaZawodnika.aspx.cs" Inherits="Powtórzenie.EdycjaZawodnika" %>
            ...
            <div class="row">
                <div class="col-md-6 pr-1">
                    <div class="form-group">
                        <label>Imie</label>
                        <%--<input type="text" class="form-control" placeholder="Imie" value="<%= Zawodnik.Imie %>">--%>
                ...
                <div class="col-md-6 pl-1">
                    <div class="form-group">
                        ...
                        <%--<input type="text" class="form-control" placeholder="Nazwisko" value="<%= Zawodnik.Nazwisko %>">--%>
            ...
            <div class="row">
                ...
                <div class="col-md-4 pl-1">
                    <div class="form-group">
                        ...
                        <%--<input type="text" class="form-control" placeholder="Data urodzenia" value="<%= Zawodnik.DataUr?.ToString("dd-MM-yyyy") %>">--%>
